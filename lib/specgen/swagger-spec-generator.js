 ...
 * @returns {Object}
 */
module.exports = function createSwaggerObject(loopbackApplication, opts, ds, dsName) {
  dsName = dsName || '';
  opts = _.defaults(opts || {}, {
    basePath: (loopbackApplication.get('restApiRoot') || '/api') + dsName,
  ...
  if (ds) {
    ...
    models = loopbackRegistry.modelBuilder.models;
  }
  ...
  loopbackApplication.emit('swaggerResources' + dsName, swaggerObject);
